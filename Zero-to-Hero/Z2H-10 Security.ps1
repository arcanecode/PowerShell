...
$demoPath = 'C:\Users\Arcane\OneDrive\PS\Z2H\'
$doSomething = "$($demoPath)Z2H-10 do something.ps1"
$doSomethingSigned = "$($demoPath)Z2H-10 do something signed.ps1"
